namespace SSDTLifecycleExtension.Commands
{
    ...
    internal sealed class ScriptCreationWindowCommand
    {
        ...
        private ScriptCreationWindowCommand(SSDTLifecycleExtensionPackage package, OleMenuCommandService commandService)
        {
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            {
                ToolWindowPane window = await _package.ShowToolWindowAsync(typeof(ScriptCreationWindow), 0, true, _package.DisposalToken);
