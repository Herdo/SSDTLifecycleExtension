    ...
    public sealed class DefaultConstraint : IEquatable<DefaultConstraint>
    {
        ...
        public bool Equals(DefaultConstraint other)
        {
            ...
            if (ReferenceEquals(this, other))
                return true;
            return string.Equals(TableSchema, other.TableSchema) && string.Equals(TableName, other.TableName) && string.Equals(ColumnName, other.ColumnName) && string.Equals(ConstraintName, other.ConstraintName);
        }
