namespace SSDTLifecycleExtension.Shared.Contracts.Services
{
    ...
    public interface IVersionService
    {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="version"/> or p<paramref name="configuration"/> are <b>null</b>.</exception>
        /// <exception cref="InvalidOperationException">The <paramref name="configuration"/>.<see cref="ConfigurationModel.VersionPattern"/> is not valid.</exception>
