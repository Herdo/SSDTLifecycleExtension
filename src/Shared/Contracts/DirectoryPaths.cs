namespace SSDTLifecycleExtension.Shared.Contracts
{
    ...
    public class DirectoryPaths
    {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="projectDirectory"/>, <paramref name="latestArtifactsDirectory"/> or <paramref name="newArtifactsDirectory"/> are <b>null</b>.</exception>
