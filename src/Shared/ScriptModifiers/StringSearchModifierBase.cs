...
public abstract class StringSearchModifierBase
{
    ...
    /// <remarks>
    ///     The <b>EndIndex</b> might equal <paramref name="input" />.<see cref="string.Length" />, when no final GO
    ...
    ///     6:    GO
    ///     7:    PRINT 'Bye world'
    ///     <paramref name="numberOfLeadingStatementsToInclude" /> = 0 would include the beginning of line 4 until the
    ///     beginning of line 7.
    ///     <paramref name="numberOfLeadingStatementsToInclude" /> = 1 or higher would include the beginning of line 1 until
    ...
    /// <summary>
    ///     Searches the <paramref name="input" /> for the <paramref name="statement" /> and applies the
    ///     <paramref name="modifier" /> for each match.
    /// </summary>
    /// <param name="input">The text to search in.</param>
    /// <param name="statement">The text to search for.</param>
    ...
    /// <returns>
    ///     The <paramref name="input" /> string, if no match is found, otherwise the result after applying the
    ///     modifications.
    /// </returns>
